...
function combinesWithPrecedingClassRange(expression, classRange) {
  if (classRange && classRange.type === 'ClassRange') {
    ...
    if (fitsInClassRange(expression, classRange)) {
      ...
      // [a-gc-e] -> [a-g]
      return true;
    } else if (expression.type === 'Char' && !isNaN(expression.codePoint) && classRange.to.codePoint === expression.codePoint - 1) {
      // [a-de] -> [a-e]
...
function combinesWithFollowingClassRange(expression, classRange) {
  if (classRange && classRange.type === 'ClassRange') {
    ...
    // [ab-e] -> [a-e]
    if (expression.type === 'Char' && !isNaN(expression.codePoint) && classRange.from.codePoint === expression.codePoint + 1) {
